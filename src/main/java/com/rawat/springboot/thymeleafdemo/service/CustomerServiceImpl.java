...
import com.rawat.springboot.thymeleafdemo.dao.CustomerRepository;
...
public class CustomerServiceImpl implements CustomerService {
	...
	public Customer findByUniqueCustomer(String theUnique) {
		Optional<Customer> result = Optional.of(customerRepository.findByUniqueCustomer(theUnique));
		...
		if (result.isPresent()) {
			...
			// we didn't find the employee
			throw new RuntimeException("Did not find Customer - " + theUnique);
		}
